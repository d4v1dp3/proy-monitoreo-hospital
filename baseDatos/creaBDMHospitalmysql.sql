...
(
	`SAT_OXIGENO_MIN` FLOAT(4,2) NOT NULL DEFAULT 85.0,
    `SAT_OXIGENO_MIN_INTER` FLOAT(4,2) NOT NULL DEFAULT 90.0, 
	`SAT_OXIGENO_MAX_INTER` FLOAT(5,2) NOT NULL DEFAULT 97.0,
    `SAT_OXIGENO_MAX` FLOAT(5,2) NOT NULL DEFAULT 100.0,
    `TEMPERATURA_MIN` FLOAT(4,2) NOT NULL DEFAULT 32.5,
    `TEMPERATURA_MIN_INTER` FLOAT(4,2) NOT NULL DEFAULT 35.5,
	`TEMPERATURA_MAX_INTER` FLOAT(4,2) NOT NULL DEFAULT 37.5,
    `TEMPERATURA_MAX` FLOAT(4,2) NOT NULL DEFAULT 40.5,
    `CAPNOGRAFIA_MIN` SMALLINT NOT NULL DEFAULT 35,
    `CAPNOGRAFIA_MIN_INTER` SMALLINT NOT NULL DEFAULT 37,
	`CAPNOGRAFIA_MAX_INTER` SMALLINT NOT NULL DEFAULT 40,
    `CAPNOGRAFIA_MAX` SMALLINT NOT NULL DEFAULT 45,
    `FREC_CARDIACA_MIN` SMALLINT NOT NULL DEFAULT 60,
    `FREC_CARDIACA_MIN_INTER` SMALLINT NOT NULL DEFAULT 65,
	`FREC_CARDIACA_MAX_INTER` SMALLINT NOT NULL DEFAULT 75,
    `FREC_CARDIACA_MAX` SMALLINT NOT NULL DEFAULT 80,
    `FREC_RESPIRATORIA_MIN` SMALLINT NOT NULL DEFAULT 18,
	`FREC_RESPIRATORIA_MIN_INTER` SMALLINT NOT NULL DEFAULT 20,
    `FREC_RESPIRATORIA_MAX_INTER` SMALLINT NOT NULL DEFAULT 22,
    `FREC_RESPIRATORIA_MAX` SMALLINT NOT NULL DEFAULT 24,
    `ID_VALREF` SMALLINT NOT NULL,
    `PRE_ART_SISTOLICA_MIN` INT NOT NULL DEFAULT 60,
	`PRE_ART_SISTOLICA_MIN_INTER` INT NOT NULL DEFAULT 80,
    `PRE_ART_SISTOLICA_MAX_INTER` INT NOT NULL DEFAULT 120,
    `PRE_ART_SISTOLICA_MAX` INT NOT NULL DEFAULT 140,
	`PRE_ART_DIASTOLICA_MIN` INT NOT NULL DEFAULT 40,
    `PRE_ART_DIASTOLICA_MIN_INTER` INT NOT NULL DEFAULT 45,
	`PRE_ART_DIASTOLICA_MAX_INTER` INT NOT NULL DEFAULT 55,
    `PRE_ART_DIASTOLICA_MAX` INT NOT NULL DEFAULT 60,
